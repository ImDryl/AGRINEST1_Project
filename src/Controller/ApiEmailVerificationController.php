...
class ApiEmailVerificationController extends AbstractController
{
    ...
    public function verifyEmail(Request $request): JsonResponse
    {
        ...
        $this->activityLogService->log(
            ...
            'User',
            $user->getId(),
            json_encode(['source' => 'API Verify Email', 'email' => $user->getEmail()], JSON_PRETTY_PRINT)
        );
    ...
    public function resendVerification(#[CurrentUser] ?User $user): JsonResponse
    {
        ...
        $this->activityLogService->log(
            ...
            'User',
            $user->getId(),
            json_encode(['source' => 'API Resend Verification', 'email' => $user->getEmail()], JSON_PRETTY_PRINT)
        );
